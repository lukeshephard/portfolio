        ...
        <>
            ...
            <header className="fixed z-10 left-0 top-0 w-full bg-background/75 backdrop-blur-md">
                <div className="flex flex-col lg:flex-row lg:h-18 justify-between p-3">
                    <p className={`${shadowsIntoLight.className} my-auto`}><Link href="/" className="flex gap-6 text-2xl text-center lg:text-left lg:text-3xl my-auto block no-underline hover:[&>*]:text-logo-hover active:[&>*]:text-logo-active">Luke Shephard</Link></p>
            ...
            {/* Main content */}
            <main className={`pt-18 w-full m-auto`}>
